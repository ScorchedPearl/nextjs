      ...
      <div className="flex justify-center items-center mt-20 mr-40">
        <div>
          ...
          <div className="flex justify-center items-end mt-4">
            <button
              type="button"
              className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2 ml-32 w-52"
            >
              <svg
            ...
            onClick={()=>googlelogin()}
            type="button"
            className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 ml-4 w-52"
          >
            <svg
              className="w-4 h-4 me-2"
              aria-hidden="true"
          ...
          <form action={loginAction}>
            <div>
              <label htmlFor="email" className="ml-8 block text-sm font-medium">
                E-Mail Address
              </label>
              <input
                type="text"
